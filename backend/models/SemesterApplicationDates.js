...
const SemesterApplicationDatesSchema = new mongoose.Schema(
  {
    ...
    fallApplicationStartDate: { type: Date, required: true },
    fallApplicationEndDate: { type: Date, required: true },
    ...
    springApplicationStartDate: { type: Date, required: true },
    springApplicationEndDate: { type: Date, required: true },
